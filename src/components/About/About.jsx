...
function About() {
  return (
    ...
    <div className='w-[60vw] ms-auto my-[10vw]'>
      <h1 className='text-[3.8vw]   lg:text-[1.5vw]'> <p className="text-[3.8vw] md:text-[1.8vw]">Passion for Design: From <button className='btn-outline-dark btn rounded-full px-2 border-[black] border-[1px] '>Startups</button> to 
