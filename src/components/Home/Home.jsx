...
function Home() {
  return (
    <div className=' overflow-hidden w-[98.7vw] mx-auto bg-[ #F5F5F5]'>
     <div className='flex justify-between p-8 overflow-x-hidden w-[90vw] mx-auto md:mt-20'>
  ...
  <div className=' w-[80vw] md:ps-[15vw] '>
    <p className='lg:text-7xl font-semibold md:text-[3vw] sm:text-[4vw] text-[7vw]'>
      ...
      <div className=' flex-col justify-between md:mt-[10vh] mx-auto '>
        ...
        <div className='flex w-[90vw] mx-auto justify-between mt-[5vh]'>
    ...
    <Link to='https://xamorite.netlify.app/CaseStudies'>  <button className='btn rounded-full bg-black text-white px-4 py-2 ms-[5vw] mt-[4vh]'>All works</button></Link>  
      ...
      <div className='flex justify-between md:my-[20vh] my-[4vh] '>
        <div className='w-[90vw] flex justify-between mx-auto'>
          ...
          <div className='w-[90vw] md:w-[62vw]'>
            <p className='md:text-[2.5vw]  text-[4.5vw] ms-[4vw]'>Studied Web Development at <Link to='https://aptech-nigeria.com/'><button   className='p-[.3%] border-[1px] rounded-full border-black'>Aptech Education </button></Link>  And have been working in the development industry for some while now.</p>
      ...
      <ul className="md:mt-[13vh] md:w-[55vw] ms-[4vw] md:ms-auto me-[5vw]">
