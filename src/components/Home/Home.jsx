...
function Home() {
  ...
  <div className='w-[17vw] overflow-hidden sm:hidden lg:visible  md:visible '>
      ...
      <div className='flex justify-between my-[20vh] '>
        <div className='w-[90vw] flex justify-between mx-auto'>
          ...
          <div className='w-[62vw]'>
            <p className='md:text-[2.5vw] ms-[4vw]'>Studied Web Development at  <button className='p-[.3%] border-[1px] rounded-full border-black'>Aptech Education </button> And have been working in the development industry for over a decade.</p>
            <p className='w-[41.5vw] ms-[4vw] mt-[5vh] mb-[10vh] font-light'>
